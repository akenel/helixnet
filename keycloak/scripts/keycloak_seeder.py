...
KEYCLOAK_REALM = os.getenv("KEYCLOAK_REALM", "helixnet")
MASTER_REALM = "master"
ADMIN_CLIENT_ID = "admin-cli"
ADMIN_USERNAME = "admin"
ADMIN_PASSWORD = os.getenv("KEYCLOAK_ADMIN_PASSWORD") # Master admin password for bootstrap
...
def get_admin_token(realm=MASTER_REALM):
    ...
    This token is needed to manage other realms (like 'helixnet').
    """
...
def get_target_realm_roles(admin_token):
    """Retrieves all available roles in the target realm ('helixnet')."""
...
# Define the initial users and their roles in the 'helixnet' realm
INITIAL_USERS = [
    {
...
# We need to wait for Keycloak to be up and the 'helixnet' realm to be imported
