...
KEYCLOAK_URL=http://keycloak:8080/realms/kc-realm-dev
KEYCLOAK_PUBLIC_URL=https://keycloak.helix.local/realms/kc-realm-dev
KEYCLOAK_ADMIN_USER=helix_user
KEYCLOAK_ADMIN_PASSWORD=helix_pass


API_BASE="http://keycloak:8080/api/v1"
HEALTH_CHECK_URL="http://keycloak:8080/health"
