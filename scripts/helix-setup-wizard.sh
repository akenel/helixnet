...
ask_question() {
    ...
    read -p "  Your choice (press Enter for default): " response
...
║   ╚═╝  ╚═╝╚══════╝╚══════╝╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝   ╚═╝
║                                                           ║
║   Out-of-the-Box POS System for Headshops                ║
║   Vertical: Cannabis Retail (Legal Markets)              ║
║   First Case Study: Artemis Headshop, Bern               ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
