...
KEYCLOAK_BASE_URL = f"http://{KC_HOST}:{KC_HTTP_PORT}"
...
KC_USERNAME = os.environ.get('KEYCLOAK_ADMIN', 'admin') 
KC_PASSWORD = os.environ.get('KEYCLOAK_ADMIN_PASSWORD', 'admin_password_insecure_default') 
