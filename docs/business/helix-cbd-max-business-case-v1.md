...
This proposal formalizes an expansion of our existing partnership into the Italian CBD market, specifically targeting Sicily as a proof-of-concept territory.
...
> **VAT compliance is the catch.**

Italian headshops operate in grey zones. When regulators tighten (and they will), compliant operators survive. Non-compliant operators close.

HelixNet provides:
- Batch tracking from clone to customer
- Lab test integration (THC % verified)
- VAT calculation done correctly (after discounts, not before)
- Full audit trail for any inspection

**We don't just sell CBD. We sell CBD that can survive an audit.**

---

## The Ask

We propose a 12-month pilot in Sicily:
...
|------|--------|------------|
| **Italian hemp ban passes** | CBD product line illegal | Beer/snacks continue; CBD is bonus not survival |
| **THC lab variance** (0.5% tests as 0.62%) | Product seized, legal costs | Clone consistency, 0.5% target gives buffer under 0.6% limit |
| **Location partner fails** | Empty machine, lost revenue | 3-strike rule, backup locations pre-scouted |
...
| Metric | Target |
|--------|--------|
| Machines deployed | 2-3 |
| Monthly revenue (total) | €3,000-5,000 |
| Revenue split | ~70% beer/drinks, ~30% CBD |
| Compliance audits passed | 100% |
| Location partners retained | 80%+ |
...
1. Felix reviews and provides feedback
2. Sylvken designs initial packaging concepts
3. Angelo scouts and secures first Trapani location
4. Legal: Swiss GmbH paperwork initiated
5. First machine order placed with Marco

---

*This document continues with detailed market analysis, supply chain, financial projections, and risk mitigation in Pages 2-10.*
