# 3 — SHORT: "The Lift" (vertical, 9:16, ~30s)

**File:** `Short-Lift.mp4` · The payoff — the whole neighbourhood shows up.

---

## TITLE  (copy)
```
20 neighbours showed up to move a 1,000-lb crane 🐺 #Shorts
```

## DESCRIPTION  (copy — paste the live movie URL where shown)
```
...
## TAGS  (copy)
```
la piazza, community, neighbourhood, build in public, open source, shorts, mutual aid, indie hacker
```
